...
async function resolve(specifier, context, defaultResolve) {
  ...
  if (result !== null && result !== void 0 && result.url) (_currentFileDepsColle = (0, _compilationCache.currentFileDepsCollector)()) === null || _currentFileDepsColle === void 0 ? void 0 : _currentFileDepsColle.add(_url.default.fileURLToPath(result.url));
  return result;
}
